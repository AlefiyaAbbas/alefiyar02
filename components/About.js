      ...
      <div className="w-full h-screen flex flex-col items-center justify-center bg-zinc-800 font-cabinet">
        <div className="bg-slate-200 w-11/12 h-auto py-8">
          ...
          <div className="flex flex-col  justify-center items-center m-2">
            <Image src={Alef} alt="alefiya" className="w-44 h-44 border-4 border-zinc-800 m-8 md:hidden" />
            <div className="md:flex">
              ...
              <ul className="flex flex-col gap-4 text-zinc-800 pt-[340px] px-6 text-xl md:text-3xl text-justify md:p-10 md:leading-10">
                <li className="text-center md:text-left text-2xl"> Hello World, I&apos;m <b>Alefiya!</b> </li>
